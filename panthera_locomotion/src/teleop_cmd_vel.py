...
def robot_width(data):
	global width
	width = (data.angular.y + data.angular.z)/200
...
if __name__ == "__main__":
	try:
		...
		lb_status = rospy.ServiceProxy('lb_reconfig_status', Status)
		lf_status = rospy.ServiceProxy('lf_reconfig_status', Status)
		rb_status = rospy.ServiceProxy('rb_reconfig_status', Status)
		rf_status = rospy.ServiceProxy('rf_reconfig_status', Status)
